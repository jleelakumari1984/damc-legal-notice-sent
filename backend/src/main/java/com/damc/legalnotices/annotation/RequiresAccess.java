package com.damc.legalnotices.annotation;
 ...
 *
 * <p>Access is granted when the user's {@code accessLevel <= level}.
 * Lower numbers represent higher privilege (e.g. 1 = admin, 2 = manager,
 * 3 = standard user).
 *
 * <p>When placed on a class, acts as a default for all methods in that class.
